...
- **Tue-Sun 7 AM KST**: `cron: '0 22 * * 2-0'` (10 PM UTC Mon-Sat) → Morning reminder
...
5. update_readme_charts.py
   ...
   ↓
6. Git commit + push
   - Files: dashboard/weekly_dashboard.svg, README.md
   - Only commits if files changed (git diff --staged --quiet)
